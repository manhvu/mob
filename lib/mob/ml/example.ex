defmodule Mob.ML.Example do
  @moduledoc """
  Simple example of using EMLX in a Mob iOS app.
  ...
  Run this in an iOS Mob app after setting up EMLX.
  """
  ...
  @doc """
  Image classification using a quantized MobileNet model.
  """
  def image_classify(image_tensor, _model_path \\ "mobilenet_v2_quantized") do
    input =
      image_tensor
