defmodule Mob.Background do
  ...
  **Recording** (`Mob.Audio.start_recording/2`): recording switches the global
  ...
  In practice this is harmless because mob owns the audio session for all
  `Mob.Audio` functions, and none of them rely on surviving this cleanup.
  ...
  `mix mob.new` adds the necessary declarations automatically:
