defmodule Mob.Event.ComponentTest do
  @moduledoc """
  Tests for the `Mob.Event.Component` behaviour. These exercise the callback
  ...
  describe "default callbacks (use Mob.Event.Component without override)" do
